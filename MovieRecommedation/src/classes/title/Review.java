...
public class Review {
    ...
    public Review(int reviewId, User user, Title item, int rating, String comment, LocalDateTime dateAdd) {
    ...
    public String toString() {
        ...
        String formattedDate = dateAdd.format(formatter);
        ...
        sb.append("User: ").append(user.getUsername()).append("\n")
                .append("Added at: ").append(formattedDate).append("\n}\n");
        return sb.toString();
    }
}
